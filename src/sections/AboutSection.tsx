...
export default function AboutSection() {
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-5 py-20 sm:px-8 md:px-10">
      ...
      >
        <img src={MOON_ICON} alt="Moon icon" className="w-full" />
      </FadeIn>
      ...
      >
        <img src={OBJECT_3D} alt="3D object" className="w-full" />
      </FadeIn>
      ...
      >
        <img src={LEGO_ICON} alt="Lego icon" className="w-full" />
      </FadeIn>
      ...
      >
        <img src={GROUP_3D} alt="3D group" className="w-full" />
      </FadeIn>
